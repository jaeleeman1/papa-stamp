...
make(exports, 'createSession', function (account, openid, callback) {
...
make(exports, 'closeSession', function (account, openid, callback) {
...
make(exports, 'getClientSessionState', function (openid, callback) {
...
make(exports, 'getCustomerSessionList', function (account, callback) {
  // https://api.weixin.qq.com/customservice/kfsession/getsessionlist?access_token= ACCESS_TOKEN
  var url = this.endpoint + '/customservice/kfsession/getsessionlist?access_token=' + this.token.accessToken + '&kf_account=' + account;
  this.request(url, {dataType: 'json'}, wrapper(callback));
});

make(exports, 'getWaitClientSessionList', function (callback) {
