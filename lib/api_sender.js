...
sender.shoppingResSend =  function(req, res) {
    ...
    getShoppingToken(shoppingResult);
...
sender.resSend =  function(req, res) {
...
function getShoppingToken(shoppingResult) {
    ...
    function accessTokenCallback (error, response, body) {
        if (!error && response.statusCode == 200) {
            ...
            //token 받고 조립한 결과 전송
            pushShoppingChat( "oH7FywN073pRVpCF0G6nMl6iI8mg", shoppingResult );
