...
Weixin.prototype.checkSignature = function(req) {
	...
	// 获取校验参数
	// token should be set in out of lib
	//this.token = 'dnausehd5678';
...
// --------------------- 消息返回 -------------------------
// 返回文字信息
Weixin.prototype.sendResponseEmptyMsg = function() {
	// var output = "" +
	// "<xml>" + "</xml>";
	var output = "";
	this.res.type('xml');
...
Weixin.prototype.sendTransferCustomerService = function(msg) {
	var time = Math.round(new Date().getTime() / 1000);
...
Weixin.prototype.sendMsg = function(msg) {
	switch(msg.msgType) {
		...
		case 'transfer_customer_service' :
			this.sendTransferCustomerService(msg);
			break;
	}
}
