...
API.prototype.request = function (url, opts, callback) {
  console.log("API.prototype.request");
  var options = {};
...
API.prototype.getAccessToken = function (callback) {
  ...
  this.request(url, {dataType: 'json'}, wrapper(function (err, data) {
    if (err) {
      console.log("API.prototype.getAccessToken : return "+err);
      return callback(err);
    }
  ...
  console.log("API.prototype.getAccessToken : success");
  return this;
};
...
API.prototype.preRequest = function (method, args, retryed) {
  console.log("API.prototype.preRequest+");
  var that = this;
