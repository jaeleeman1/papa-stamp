...
make(exports, 'getClientSessionState', function (openid, callback) {
  ...
  var url = this.endpoint + '/customservice/getsession?access_token=' + this.token.accessToken + '&openid=' + openid;
  this.request(url, {dataType: 'json'}, wrapper(callback));
});
...
make(exports, 'getCustomerSessionList', function (account, callback) {
  ...
  var url = this.endpoint + '/customservice/getsessionlist?access_token=' + this.token.accessToken + '&kf_account=' + account;
  this.request(url, {dataType: 'json'}, wrapper(callback));
});
...
make(exports, 'getCustomerSessionList', function (callback) {
  ...
  var url = this.endpoint + '/customservice/getwaitcase?access_token=' + this.token.accessToken;
  this.request(url, {dataType: 'json'}, wrapper(callback));
});