...
make(exports, 'getClientSessionState', function (openid, callback) {
  // https://api.weixin.qq.com/cgi-bin/customservice/getsession?access_token= ACCESS_TOKEN
  var url = this.endpoint + '/cgi-bin/customservice/getsession?access_token=' + this.token.accessToken + '&openid=' + openid;
  this.request(url, {dataType: 'json'}, wrapper(callback));
});

make(exports, 'getCustomerSessionList', function (account, callback) {
  // https://api.weixin.qq.com/cgi-bin/customservice/getsessionlist?access_token= ACCESS_TOKEN
  var url = this.endpoint + '/cgi-bin/customservice/getsessionlist?access_token=' + this.token.accessToken + '&kf_account=' + account;
  this.request(url, {dataType: 'json'}, wrapper(callback));
});

make(exports, 'getCustomerSessionList', function (callback) {
  // https://api.weixin.qq.com/cgi-bin/customservice/getwaitcase?access_token= ACCESS_TOKEN
  var url = this.endpoint + '/cgi-bin/customservice/getwaitcase?access_token=' + this.token.accessToken;
  this.request(url, {dataType: 'json'}, wrapper(callback));
});